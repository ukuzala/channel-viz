(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'xdAqCOpDycO0muGcWICUcWuKjaJZigSEQ0YXT1XJkwFqd2xK', // Unique master Xively API key to be used as a default
		defaultFeeds	= ['1029041212'], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Roundarch Isobar Light Sensor', // Replaces Xively logo in the header
		dataDuration	= '', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= 'cc0000', // CSS HEX value of color to represent data (omit leading #)
